...
```{r}
# First we want to get rid of the 1st, 3rd and 4rd column. We want to only look at the titles and look if there 0: reliable or 1: unreliable 
cleanDF <- rawDF[c(-1,-3, -4)] %>% na.omit
head(cleanDF)
```

```{r}
# It was a numaric value with only 0s and 1s. I had to change it into a factor value with the values, Reliable and unreliable. And I switched the columns too. 
