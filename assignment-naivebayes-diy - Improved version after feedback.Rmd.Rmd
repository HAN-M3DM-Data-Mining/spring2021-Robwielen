...
<body>
 <h1 style="color:#FF0000";> I do not totally agree with Jurg. I agree that false positives are bad, because people get shown news that is unreliable. But the other way around is just as bad I think. Than the model predicts it is unreliable and it probably will be filtered out, but the article is actually reliable and people do not get to see the reliable news.</h1>
 </body>
